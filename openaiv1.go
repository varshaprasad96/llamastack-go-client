...
type OpenAiv1ModerationsResponse struct {
	...
	Results []OpenAiv1ModerationsResponseResult `json:"results,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		ID          respjson.Field
		Model       respjson.Field
...
type OpenAiv1ModerationsResponseResult struct {
	...
	Metadata map[string]OpenAiv1ModerationsResponseResultMetadataUnion `json:"metadata,required"`
...
// OpenAiv1ModerationsResponseResultMetadataUnion contains all possible properties
...
type OpenAiv1ModerationsResponseResultMetadataUnion struct {
...
func (u OpenAiv1ModerationsResponseResultMetadataUnion) AsBool() (v bool) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u OpenAiv1ModerationsResponseResultMetadataUnion) AsFloat() (v float64) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u OpenAiv1ModerationsResponseResultMetadataUnion) AsString() (v string) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u OpenAiv1ModerationsResponseResultMetadataUnion) AsAnyArray() (v []any) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u OpenAiv1ModerationsResponseResultMetadataUnion) RawJSON() string { return u.JSON.raw }

func (r *OpenAiv1ModerationsResponseResultMetadataUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
