...
// LLAMASTACK_GO_CLIENT_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("LLAMASTACK_GO_CLIENT_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("LLAMASTACK_GO_CLIENT_API_KEY"); ok {
...
// environment (LLAMASTACK_GO_CLIENT_API_KEY, LLAMASTACK_GO_CLIENT_BASE_URL). The
