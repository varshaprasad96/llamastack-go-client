...
func TestSyntheticDataGenerationGenerateWithOptionalParams(t *testing.T) {
	...
	_, err := client.SyntheticDataGeneration.Generate(context.TODO(), llamastackgoclient.SyntheticDataGenerationGenerateParams{
		Dialogs: []llamastackgoclient.MessageUnionParam{{
		...
		FilteringFunction: llamastackgoclient.SyntheticDataGenerationGenerateParamsFilteringFunctionNone,
