...
func TestToolGet(t *testing.T) {
	...
	_, err := client.Tools.Get(context.TODO(), "tool_name")
	if err != nil {
...
func TestToolListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Tools.List(context.TODO(), llamastackgoclient.ToolListParams{
		ToolgroupID: llamastackgoclient.String("toolgroup_id"),
	})
	if err != nil {
		var apierr *llamastackgoclient.Error
		if errors.As(err, &apierr) {
